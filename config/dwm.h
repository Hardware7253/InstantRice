...
static const char *fonts[]          = { "JetBrains Mono:style=regular:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "JetBrains Mono:style=regular:pixelsize=18:antialias=true:autohint=true";
